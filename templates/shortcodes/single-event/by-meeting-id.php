<?php
/**
 * The Template for displaying single event detail
 *
 * This template can be overridden by copying it to yourtheme/video-conferencing-webex/shortcode/single-event/by-meeting-id.php
 *
