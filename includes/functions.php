...
function vcw_getAllTimezone() {
	...
	return apply_filters( 'vcw_getAllTimezone', $zones_array );
}
...
function vcw_get_filesize( $bytes ) {
	if ( $bytes >= 1073741824 ) {
